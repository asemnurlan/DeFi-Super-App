  ...
  <div id="content"><!---->
    <div id="main-frame-error" class="interstitial-wrapper ">
      <div id="main-content">
        ...
        <div id="main-message">
          <h1>
            <span>Не удается открыть эту страницу</span>
          </h1>
          <!--?lit$290947419$-->
            <p>Проверьте, нет ли опечатки в <span>cdn.ethers.io</span>.</p>
          
          <div id="diagnose-frame" class="hidden"></div>

          <!--?lit$290947419$-->

          <div class="error-code"><!--?lit$290947419$-->DNS_PROBE_FINISHED_NXDOMAIN</div>
      ...
      <div id="buttons" class="nav-wrapper suggested-left">
        <div id="control-buttons">
          <!--?lit$290947419$-->
      <!--?lit$290947419$-->
        <button id="reload-button" class="blue-button text-button" data-url="https://cdn.ethers.io/lib/ethers-5.2.umd.min.js">
          <!--?lit$290947419$-->Обновить
        </button>
      <!--?-->
        </div>
        <!--?lit$290947419$-->
    ...
    <!--?lit$290947419$-->
      <div class="footer">
        <div class="left-footer">
          <div class="edge-logo" alt=""></div>
          <div class="edge-branding-text"><!--?lit$290947419$-->Microsoft Edge</div>
        </div>
      </div>
    ...
    <!--?lit$290947419$-->
      <div id="sub-frame-error">
        <!-- Show details when hovering over the icon, in case the details are
             hidden because they're too large. -->
        <div class="icon "></div>
        <div id="sub-frame-error-details">Проверьте, нет ли опечатки в <span>cdn.ethers.io</span>.</div>
        <!--?lit$290947419$-->
      </div>
